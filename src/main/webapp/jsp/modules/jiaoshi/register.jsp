...
<body style="background-image:url('/shiyanshipaike/img/back-img-bg.jpg') !important;background-size:cover;">
<!-- Pre Loader -->
<div class="loading">
    <div class="spinner">
                        ...
                        <form id="register">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    <label>工号</label>
                                    <input id="jiaoshiUuidNumber" name="jiaoshiUuidNumber" class="form-control"
                                           placeholder="工号">
                                </div>
                                <div class="form-group col-md-12">
                                    <label>账户</label>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input id="jiaoshiPhone" name="jiaoshiPhone" class="form-control"
                                           onchange="jiaoshiPhoneChickValue(this)"  placeholder="联系方式">
                                </div>
                                <div class="form-group col-md-12">
                                    <label>邮箱</label>
    ...
    <script>
        ...
        function submit() {
            ...
            if (validform() == true && compare() == true) {
                ...
                var urlParam;
                var successMes = '';
                httpJson("jiaoshi/register", "POST", data, (res) => {
                    if(res.code == 0){
        ...
        function jiaoshiDeleteChickValue(e){
            var this_val = e.value || 0;
            /*if(this_val == 0){
                e.value = "";
                alert("0不允许输入");
        ...
        function validform() {
            return $("#register").validate({
                rules: {
                        ...
                        jiaoshiEmail: "required",
                        jiaoshiDelete: "required",
                },
                messages: {
                        jiaoshiUuidNumber: "工号不能为空",
                        username: "账户不能为空",
                        password: "密码不能为空",
                        jiaoshiName: "教师姓名不能为空",
                        jiaoshiPhoto: "头像不能为空",
                        sexTypes: "性别不能为空",
                        jiaoshiPhone: "联系方式不能为空",
                        jiaoshiEmail: "邮箱不能为空",
                        jiaoshiDelete: "假删不能为空",
                }
            }).form();
        }
