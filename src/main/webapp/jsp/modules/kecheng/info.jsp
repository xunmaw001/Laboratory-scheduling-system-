                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="shiyanshishenqingId" name="shiyanshishenqingId" v-model="ruleForm.shiyanshishenqingId" readonly type="hidden">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>上课时间</label>
                                        <input style="width: 450px" id="shangkeTime" name="shangkeTime" class="form-control"
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>结束时间</label>
                                        <input style="width: 450px" id="xiakeTime" name="xiakeTime" class="form-control"
                                ...
                                <div class="form-group col-md-6">
                                    <label>学期</label>
                                    <input style="width: 450px" id="xueqiValue" name="xueqiValue" class="form-control"
                                           v-model="ruleForm.xueqiValue" readonly>
                                </div>

                                <div class="form-group col-md-6">
                                    <label>星期</label>
                                    <input style="width: 450px" id="xingqiValue" name="xingqiValue" class="form-control"
                                           v-model="ruleForm.xingqiValue" readonly>
                                </div>

                                <div class="form-group col-md-6">
                                    <label>第几节</label>
                                    <input style="width: 450px" id="jiekeValue" name="jiekeValue" class="form-control"
                                           v-model="ruleForm.jiekeValue" readonly>
                                </div>
                                <input id="jiaoshiId" name="jiaoshiId" v-model="ruleForm.jiaoshiId" readonly type="hidden">

                                <div class="form-group col-md-6">
                                    <label>课程审核</label>
                                    <input style="width: 450px" id="kechengYesnoValue" name="kechengYesnoValue" class="form-control"
                                           v-model="ruleForm.kechengYesnoValue" readonly>
                                </div>

                                    <div class="form-group col-md-6">
                                        <label>审核原因</label>
                                        <input style="width: 450px" id="kechengYesnoText" name="kechengYesnoText" class="form-control"
                                               v-model="ruleForm.kechengYesnoText" readonly>
                                    </div>
