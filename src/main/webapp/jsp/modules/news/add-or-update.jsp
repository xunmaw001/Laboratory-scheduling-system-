                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 newsTypesDiv">
                                        <label>公告类型</label>
                                        <select style="width: 450px" id="newsTypesSelect" name="newsTypes" class="form-control">
                                        </select>
                                    </div>
    ...
    function getContent() {
        ...
        if($("#newsContentupload").length>0) {
            ...
            if (newsContentEditor.hasContents()) {
                $('#newsContent-input').attr('value', newsContentEditor.getContent());
            }
        }
    }
    //数字检查
